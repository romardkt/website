...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="row">
            <div class="col-sm-4">
                {!! Form::label('Name') !!}
                {!! Form::text('participant_name', $user->fullname(), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
            </div>
            <div class="col-sm-5">
                {!! Form::label('Email Address') !!}
                {!! Form::email('participant_email', $user->parentObj->email, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
            </div>
            <div class="col-sm-3">
                {!! Form::label('Phone') !!}
                {!! Form::text('participant_phone', $user->parentObj->profile->phone, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="row">
            <div class="col-sm-4">
                {!! Form::label('Name') !!}
                {!! Form::text('ice1_name', $user->parentObj->fullname(), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
            </div>
            <div class="col-sm-5">
                {!! Form::label('Email Address') !!}
                {!! Form::email('ice1_email', $user->parentObj->email, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
            </div>
            <div class="col-sm-3">
                {!! Form::label('Phone') !!}
                {!! Form::text('ice1_phone', $user->parentObj->profile->phone, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
                <span class="help-block">Format: ###-###-####</span>
            </div>
        </div>
        <br/>
        ...
        <div class="row">
            <div class="col-sm-4">
                {!! Form::label('Name') !!}
                {!! Form::text('ice2_name', null, ['class' => 'form-control']) !!}
            </div>
            <div class="col-sm-5">
                {!! Form::label('Email Address') !!}
                {!! Form::email('ice2_email', null, ['class' => 'form-control']) !!}
            </div>
            <div class="col-sm-3">
                {!! Form::label('Phone') !!}
                {!! Form::text('ice2_phone', null, ['class' => 'form-control']) !!}
                <span class="help-block">Format: ###-###-####</span>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-8">
                {!! Form::label('Name') !!}
                {!! Form::text('ice3_name', null, ['class' => 'form-control']) !!}
            </div>
            <div class="col-sm-4">
                {!! Form::label('Phone') !!}
                {!! Form::text('ice3_phone', null, ['class' => 'form-control']) !!}
                <span class="help-block">Format: ###-###-####</span>
            </div>
        </div>
        <p><br/></p>
    ...
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('physician_phone', null, ['class' => 'form-control']) !!}
                <span class="help-block">Format: ###-###-####</span>
            </div>
        </div>
        <div class="row">
