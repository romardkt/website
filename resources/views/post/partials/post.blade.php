        ...
        <div class="form-group">
            ...
            <span class="help-block">If you change this it will change the url</span>
        </div>
        ...
        <div class="form-group">
            ...
            {{ Form::text('post_at_date', (isset($post)) ? convertDate($post->post_at, 'm/d/Y') : null, ['class' => 'form-control datepicker text-center']) }}
        </div>

        <div class="form-group">
            {{ Form::label('Post At Time') }}
            {{ Form::text('post_at_time', (isset($post)) ? convertDate($post->post_at, 'h:i A') : null, ['class' => 'form-control clockpicker text-center']) }}
        </div>
