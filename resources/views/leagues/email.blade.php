...
<div class="row">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10">
        ...
        <div class="form-group">
            ...
            {{ Form::text('from', (isset($isAuthorized['userData'])) ? $isAuthorized['userData']->email : null, ['class' => 'form-control']) }}
            <span class="help-block">Make sure this is correct to receive a reply</span>
        </div>

        <div class="form-group">
            {{ Form::label('Your Name') }}
            {{ Form::text('name', (isset($isAuthorized['userData'])) ? $isAuthorized['userData']->fullname() : null, ['class' => 'form-control']) }}
        </div>
