<div class="row">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('Gender') }}
            <div class="checkbox">
                {{ Form::radio('gender', 'Male', $session->registrant->gender == 'Male', ['id' => 'gender-male']) }} &nbsp;{{ Form::label('gender-male', 'Male') }}
                &nbsp;&nbsp;&nbsp;&nbsp;
                {{ Form::radio('gender', 'Female', $session->registrant->gender == 'Female', ['id' => 'gender-female']) }} &nbsp;{{ Form::label('gender-female', 'Female') }}
            </div>
        </div>
