...
<div class="row">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10">
        <h2 style="text-align: center;">Information for Parent/Fans</h2>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 text-justify">
        <p>
            Congratulations on supporting a team that made it to Nationals! Cincinnati Ultimate Players Association (CUPA) welcomes you to Cincinnati/Mason for the tournament and are hoping to provide you with much needed information for you to plan your travels and make the weekend a great time.
        </p>
        <br/>
        <p>
            <h4 style="text-decoration: underline;">Before you come:</h4>
            <p>
                Get to know Ultimate: If you are new to the sport of Ultimate, knowing what to expect before you get here will make your weekend more enjoyable. We suggest a couple of things:
            </p>
            <ul>
                <li>
        ...
        <br/>
        <p>
            <h4 style="text-decoration: underline;">What you need to know:</h4>
            <p>
                <strong style="text-decoration: underline;">Lodging:</strong>
                <em>
                    While there are many hotel choices, Memorial Day weekend is a very busy time, so booking early will give you the best option. Hotels in Mason will be 10-12 minutes from the fields while hotels in West Chester will be 15-20 minutes.  See attached list of hotels for quick options.
                </em>
            </p>
        </p>
        <br/>
        <p>
            <h4 style="text-decoration: underline;">Once you are here:</h4>
            <p>
                <strong style="text-decoration: underline;">Fields:</strong>
                <ul>
                    <li>
                        Pool Play &amp; Quarterfinals will take place Fri, Sat, Sun at <a targe="_new" href="https://goo.gl/maps/syibT">Heritage Oak Park</a> (4601 U.S. 42, Mason, OH 45040).
                    </li>
                    <li>
                        Semi-finals and Finals will occur Sun &amp; Monday at <a targe="_new" href="https://goo.gl/maps/CgA8N">Mason High School</a> (6100 Mason Montgomery Rd., Mason, OH 45040)
                    </li>
                </ul>
                <strong style="text-decoration: underline;">Parking:</strong>
                <p>
                    There is adequate parking at the fields. We recommend getting to the fields about 20 minutes before game time. The daily parking fee is <strong>$10</strong>
                </p>
                <strong style="text-decoration: underline;">Schedule:</strong>
                <p>
                    The schedule is not created/posted at this time.
                </p>
            </p>
        </p>
        <br/>
        <p>
            <h4 style="text-decoration: underline;">What's Important to know:</h4>
            <p>
                Feeding the team: just a few minutes from the park on Mason-Montgomery Rd, you will find all you need - Kroger, Whole Foods, Walmart
            </p>
            <p>
                If you need other supplies as well, in the same area is Dick’s Sporting Goods, CVS, Walgreens, etc.  Restaurants: there is a list of nearby restaurants on the lodging page.
            </p>
        </p>
        <br/>
        <p>
