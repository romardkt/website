...
<div class="row">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10">
        ...
        <div class="form-group">
            <div class="checkbox">
                {!! Form::checkbox('use_bid', 1) !!} Use the online bid system?
            </div>
        </div>

        <div class="form-group">
            <div class="checkbox">
                {!! Form::checkbox('is_visible', 1) !!} Tournament page visible?
            </div>
        </div>

        <div class="form-group">
            <div class="checkbox">
                {!! Form::checkbox('has_teams', 1) !!} Tournament has team management?
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="checkbox">
                {!! Form::checkbox('tenative_date', 1) !!} Dates Tenative?
            </div>
        </div>
